...
export default (state = null, action) => {
  ...
  switch(action.type) {
    // Returns the user property of the action object, which is the json of the user from the database. This sets the currentUser portion of the Redux store to this data
